          ...
          <div class="form-group col col-md-12">
            ...
            <div class="col col-md-2">
              <div class="col-md-8" style="padding: 0">
                  <input name="data[photographer][zip_code]" class="form-control ime-disabled" maxLength="8" type="tel" value=""/>
              </div>
              <div class="col col-md-4 text-center" style="margin-top: 6px;">
                      <button type="button" class="btn btn-warning btn-xs btn-click" onclick="AjaxZip3.zip2addr('data[photographer][zip_code]', '', 'data[photographer][pref_id]', 'data[photographer][address1]');">住所検索</button>
                    </div>
            </div>
          </div>
          <div class="form-group col col-md-12">
