  ...
  <script type="text/javascript">
      ...
      $(document).ready(function(){
          ...
          $(document).on('click','#changePassword',function(){
              ...
              var html = '<div><div class="col col-md-2"><input name="data[trader][password]" minlength="6" maxLength="50" id="trader_password" class="form-control" type="password"/></div></div>';
  ...
  <div id="container">
    ...
    <div id="content">
      ...
      <div id="traders_edit_page" class="col col-md-10 col-md-offset-1">
        ...
        @endif
        <form action="/trader/edit/{{$trader['id']}}" class="well form-horizontal" id="TraderEditForm" method="post" accept-charset="utf-8">
          ...
          <fieldset>
            ...
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                <input name="data[trader][phonetic]" class="form-control hiragana" value="{{$trader['phonetic']}}" maxLength="100" type="text"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
            ...
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                <input name="data[trader][address]" class="form-control" value="{{$trader['address']}}" maxLength="100" type="text"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="TraderAddress" class="col col-md-2 control-label">建物名・部屋番号等</label>
              <div class="col col-md-5">
                <input name="data[trader][building_name]" class="form-control" value="{{$trader['building_name']}}" maxLength="100" type="text"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="TraderPhoneNumber" class="col col-md-2 control-label">電話番号</label>
              <div class="col col-md-2">
                <input name="data[trader][phone_number]" class="form-control" value="{{$trader['phone']}}" maxLength="13" type="tel"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="TraderFaxNumber" class="col col-md-2 control-label">FAX番号</label>
              <div class="col col-md-2">
                <input name="data[trader][fax_number]" value="{{$trader['fax']}}" class="form-control" maxLength="13" type="tel"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="TraderFaxNumberForSendPdf" class="col col-md-2 control-label">精算明細書送付先FAX番号</label>
              <div class="col col-md-2">
                <input name="data[trader][destination_fax]" value="{{$trader['destination_fax']}}" class="form-control" maxLength="13" type="tel"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="TraderChargeName" class="col col-md-2 control-label">担当者名</label>
              <div class="col col-md-2">
                <input name="data[trader][contact_name]" class="form-control" maxLength="50" type="text" value="{{$trader['contact_name']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="TraderChargeKanaName" class="col col-md-2 control-label">担当者名 (ふりがな)</label>
              <div class="col col-md-2">
                <input name="data[trader][furigana_name]" class="form-control hiragana" maxLength="50" type="text" value="{{$trader['furigana_name']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="TraderChargePhoneNumber" class="col col-md-2 control-label">担当者電話番号</label>
              <div class="col col-md-2">
                <input name="data[trader][furigana_phone]" class="form-control" maxLength="13" type="tel" value="{{$trader['furigana_phone']}}" />
              </div>
            </div>
            ...
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                <input name="data[trader][email]" class="form-control" maxLength="100" type="email" value="{{$trader['email']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="TraderUrl" class="col col-md-2 control-label">WEBサイト</label>
              <div class="col col-md-5">
                <input name="data[trader][website]" type="url" class="form-control" maxLength="255" value="{{$trader['website']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="contractdate" class="col col-md-2 control-label">サービス利用申込日</label>
              <div class="col col-md-2">
                <input name="data[trader][service_date]" class="form-control" maxLength="10" id="contractdate" type="tel" value="{{date('Y-m-d',strtotime($trader['service_date']))}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="contractdate1" class="col col-md-2 control-label">古物商許可証確認日</label>
              <div class="col col-md-2">
                <input name="data[trader][curio_date]" class="form-control" maxLength="10" id="contractdate1" type="tel" value="{{date('Y-m-d',strtotime($trader['curio_date']))}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="" class="col col-md-2 control-label">古物商許可証番号</label>
              <div class="col col-md-2">
                <input name="data[trader][permit_number]" class="form-control" maxLength="13" type="tel" value="{{$trader['permit_number']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="contractdate2" class="col col-md-2 control-label">その他申込時必要書類確認日</label>
              <div class="col col-md-2">
                <input name="data[trader][document_confirmation_date]" class="form-control" maxLength="10" id="contractdate2" type="tel" value="{{date('Y-m-d',strtotime($trader['document_confirmation_date']))}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="" class="col col-md-2 control-label">備考</label>
              <div class="col col-md-5">
                <textarea name="data[trader][remark]" class="form-control" rows="5" cols="30" id="">{{$trader['remark']}}</textarea>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <div class="form-group col col-md-12">
                ...
                <div class="col col-md-5">
                  <label class="radio-inline" for="shucho0">
                    <input type="radio" name="data[trader][assessment_classification]" id="shucho0" value="0" <?php if ($trader['assessment_classification']==0) echo 'checked'?> />
                    不可</label>
                  <label class="radio-inline" for="shucho1">
                    <input type="radio" name="data[trader][assessment_classification]" id="shucho1" value="1" <?php if ($trader['assessment_classification']==1) echo 'checked'?>/>
                    可</label>
                </div>
              </div>
            </div>
            ...
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-2">
                <input name="data[trader][assessment_price]" onkeyup="reformatText(this)" value="{{number_format($trader['assessment_price'])}}" class="form-control" maxLength="13" type="tel"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="" class="col col-md-2 control-label">出張査定回数</label>
              <div class="col col-md-2">
                <input name="data[trader][assessment_trip]" class="form-control" maxLength="13" type="tel" value="{{$trader['assessment_trip']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="" class="col col-md-2 control-label">備考</label>
              <div class="col col-md-5">
                <textarea name="data[trader][remark1]" class="form-control" rows="5" cols="30" id="">{{$trader['remark1']}}</textarea>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="TraderTerritory" class="col col-md-2 control-label">出張査定対応地域</label>
              <div class="col col-md-5">
                <textarea  name="data[trader][assessment_area]" value="" class="form-control" rows="3" cols="30" id="TraderTerritory">{{$trader['assessment_area']}}</textarea>
                  <input type="hidden" id="Trader_erea" value="{{$trader['assessment_area']}}"></input>
              ...
              <div class="form-group col col-md-12">
                ...
                <div class="col col-md-5">
                  ...
                  <label class="radio-inline" for="tokukomi0">
                    <input type="radio" name="data[trader][bring_assessment]" id="tokukomi0" value="0" <?php if ($trader['bring_asssessment']==0) echo 'checked'?> />
                    不可</label>
                  <label class="radio-inline" for="tokukomi1">
                    <input type="radio" name="data[trader][bring_assessment]" id="tokukomi1" value="1" <?php if ($trader['bring_asssessment']==1) echo 'checked'?>  />
                    可</label>
                </div>
              </div>
            </div>
            ...
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-2">
                <input name="data[trader][bought_price]" onkeyup="reformatText(this)" class="form-control" maxLength="13" type="tel" value="{{number_format($trader['bought_price'])}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="" class="col col-md-2 control-label">持込査定回数</label>
              <div class="col col-md-2">
                <input name="data[trader][bought_frequency]" class="form-control" maxLength="13" type="tel" value="{{$trader['bought_frequency']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="" class="col col-md-2 control-label">備考</label>
              <div class="col col-md-5">
                <textarea name="data[trader][remark2]" class="form-control" rows="5" cols="30" id="">{{$trader['remark2']}}</textarea>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <div class="form-group col col-md-12">
                ...
                <div class="col col-md-5">
                  <label class="radio-inline" for="Staff_stt0">
                    <input type="radio" name="data[trader][member_status]" id="Staff_stt0" value="0" <?php if ($trader['member_status']==0) echo 'checked' ?>/>
                    非会員</label>
                  <label class="radio-inline" for="Staff_stt1">
                    <input type="radio" name="data[trader][member_status]" id="Staff_stt1" value="1" <?php if ($trader['member_status']==1) echo 'checked' ?> />
                    無料会員</label>
                  <label class="radio-inline" for="Staff_stt2">
                    <input type="radio" name="data[trader][member_status]" id="Staff_stt2" value="2" <?php if ($trader['member_status']==2) echo 'checked' ?> />
                    有料会員</label>
                  <label class="radio-inline" for="Staff_stt3">
                    <input type="radio" name="data[trader][member_status]" id="Staff_stt3" value="3" <?php if ($trader['member_status']==3) echo 'checked' ?> />
                    取引中止</label>
                </div>
              </div>
            </div>
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                <textarea name="data[trader][remark3]" class="form-control" rows="5" cols="30" id="">{{$trader['remark3']}}</textarea>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <div class="form-group col col-md-12">
                ...
                <div class="col col-md-5">
                  <label class="radio-inline" for="Exhi0">
                    <input type="radio" name="data[trader][bid_approval]" id="Exhi0" value="0" @if($trader['bid_approval']==0) {{'checked'}} @endif />
                    不可</label>
                  <label class="radio-inline" for="Exhi1">
                    <input type="radio" name="data[trader][bid_approval]" id="Exhi1" value="1" @if($trader['bid_approval']==1) {{'checked'}} @endif />
                    可</label>
                </div>
              </div>
            </div>
            <div class="form-group col col-md-12 smart_membership">
              ...
              <div class="col col-md-5">
                <label class="radio-inline" for="TraderSmart0">
                  <input type="radio" name="data[trader][service_classification]" id="TraderSmart0" value="0" @if($trader['service_classification']==0) {{'checked'}} @endif />
                  利用不可</label>
                <label class="radio-inline" for="TraderSmart1">
                  <input type="radio" name="data[trader][service_classification]" id="TraderSmart1" value="1"@if($trader['service_classification']==1) {{'checked'}} @endif />
                  利用可</label>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="" class="col col-md-2 control-label">備考</label>
              <div class="col col-md-5">
                <textarea name="data[trader][remark4]" class="form-control" rows="5" cols="30" id="">{{$trader['remark4']}}</textarea>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <div class="form-group col col-md-12">
                ...
                <div class="col col-md-5">
                  <label class="radio-inline" for="Exhibit0">
                    <input type="radio" name="data[trader][email_classification]" id="Exhibit0" value="0" @if($trader['email_classification']==0) {{'checked'}} @endif  />
                    送信可</label>
                  <label class="radio-inline" for="Exhibit1">
                    <input type="radio" name="data[trader][email_classification]" id="Exhibit1" value="1" @if($trader['email_classification']==1) {{'checked'}} @endif  />
                    送信不可</label>
                </div>
              </div>
            </div>
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                <input name="data[trader][new_email]" class="form-control" maxLength="100" type="email" value="{{$trader['new_email']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <div class="form-group col col-md-12">
                ...
                <div class="col col-md-5">
                  <label class="radio-inline" for="ExhibitR0">
                    <input type="radio" name="data[trader][promotion_email_classification]" id="ExhibitR0" value="0" @if($trader['promotion_email_classification']==0) {{'checked'}} @endif />
                    可</label>
                  <label class="radio-inline" for="ExhibitR1">
                    <input type="radio" name="data[trader][promotion_email_classification]" id="ExhibitR1" value="1" @if($trader['promotion_email_classification']==1) {{'checked'}} @endif />
                    不可</label>
                </div>
              </div>
            </div>
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                <input name="data[trader][promotion_email]" class="form-control" maxLength="100" type="email" value="{{$trader['promotion_email']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <div class="form-group col col-md-12">
                ...
                <div class="col col-md-5">
                  <label class="radio-inline" for="ExhibitRx0">
                    <input type="radio" name="data[trader][business_email_classification]" id="ExhibitRx0" value="0" @if($trader['business_email_classification']==0) {{'checked'}} @endif  />
                    可</label>
                  <label class="radio-inline" for="ExhibitRx1">
                    <input type="radio" name="data[trader][business_email_classification]" id="ExhibitRx1" value="1" @if($trader['business_email_classification']==1) {{'checked'}} @endif  />
                    不可</label>
                </div>
              </div>
            </div>
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                <input name="data[trader][business_email]" class="form-control" maxLength="100" type="email" value="{{$trader['business_email']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="parent_trader_name" class="col col-md-2 control-label">親会社</label>
              <div class="col col-md-2">
                <input name="data[trader][parent_company]" class="form-control" id="parent_trader_name" value="{{$trader['parent_company']}}" type="text"/>
              </div>
            </div>
            ...
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-7">
                <label class="radio-inline" for="TraderMainBusiness1">
                  <input type="radio" name="data[trader][business_type]" id="TraderMainBusiness1" value="1" @if($trader['business_type']==1) {{'checked'}} @endif  />
                  解体業者</label>
                <label class="radio-inline" for="TraderMainBusiness2">
                  <input type="radio" name="data[trader][business_type]" id="TraderMainBusiness2" value="2" @if($trader['business_type']==2) {{'checked'}} @endif  />
                  陸送業者</label>
                <label class="radio-inline" for="TraderMainBusiness3">
                  <input type="radio" name="data[trader][business_type]" id="TraderMainBusiness3" value="3" @if($trader['business_type']==3) {{'checked'}} @endif  />
                  レッカー業者</label>
                <label class="radio-inline" for="TraderMainBusiness4">
                  <input type="radio" name="data[trader][business_type]" id="TraderMainBusiness4" value="4" @if($trader['business_type']==4) {{'checked'}} @endif  />
                  輸出業者</label>
                <label class="radio-inline" for="TraderMainBusiness5">
                  <input type="radio" name="data[trader][business_type]" id="TraderMainBusiness5" value="5" @if($trader['business_type']==5) {{'checked'}} @endif  />
                  中古車販売業者</label>
                <label class="radio-inline" for="TraderMainBusiness6">
                  <input type="radio" name="data[trader][business_type]" id="TraderMainBusiness6" value="6" @if($trader['business_type']==6) {{'checked'}} @endif  />
                  整備業者</label>
                <label class="radio-inline" for="TraderMainBusiness7">
                  <input type="radio" name="data[trader][business_type]" id="TraderMainBusiness7" value="7" @if($trader['business_type']==7) {{'checked'}} @endif  />
                  ガソリンスタンド</label>
              </div>
            </div>
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-10">
                <div class="row">
                    <?php
                        $category=explode(',',$trader['category']);
//                        print_r($trader['category']);
                    ?>
                  <div class="col col-md-1 form-control-static" for="TraderScrap">
                    ...
                    <input type="checkbox" name="data[trader][category][]"  value="1" <?php if(in_array('1',$category)) echo 'checked' ?> id="TraderScrap"/>
                    解体業者 </div>
                  <div class="col col-md-1 form-control-static" for="TraderTransporter">
                    ...
                    <input type="checkbox" name="data[trader][category][]"  value="2" <?php if(in_array('2',$category)) echo 'checked' ?> id="TraderTrasnporter"/>
                    陸送業者 </div>
                  <div class="col col-md-2 form-control-static" for="TraderWrecker">
                    ...
                    <input type="checkbox" name="data[trader][category][]"  value="3" <?php if(in_array('3',$category)) echo 'checked' ?> id="TraderWrecker"/>
                    レッカー業者 </div>
                  <div class="col col-md-1 form-control-static" for="TraderExporter">
                    ...
                    <input type="checkbox" name="data[trader][category][]"  value="4" <?php if(in_array('4',$category)) echo 'checked' ?> id="TraderExporter"/>
                    輸出業者 </div>
                  <div class="col col-md-2 form-control-static" for="TraderResaler">
                    ...
                    <input type="checkbox" name="data[trader][category][]"  value="5" <?php if(in_array('5',$category)) echo 'checked' ?> id="TraderResaler"/>
                    中古車販売業者 </div>
                  <div class="col col-md-1 form-control-static" for="TraderRepair">
                    ...
                    <input type="checkbox" name="data[trader][category][]"  value="6" <?php if(in_array('6',$category)) echo 'checked' ?> id="TraderRepair"/>
                    整備業者 </div>
                  <div class="col col-md-2 form-control-static" for="TraderGasStation">
                    ...
                    <input type="checkbox" name="data[trader][category][]"  value="7" <?php if(in_array('7',$category)) echo 'checked' ?> id="TraderGasStation"/>
                    ガソリンスタンド </div>
                </div>
              </div>
            </div>
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-10">
                <div class="row">
                    <?php
                    $additional_correspondence=explode(',',$trader['additional_correspondence']);
                    ?>
                  <div class="col col-md-2 form-control-static" for="TraderCash">
                    ...
                    <input type="checkbox" name="data[trader][additional_correspondence][]"  value="1" id="TraderCash" <?php if(in_array('1',$additional_correspondence)) echo 'checked' ?>/>
                    現金対応 </div>
                  <div class="col col-md-2 form-control-static" for="TraderOnSaturday">
                    ...
                    <input type="checkbox" name="data[trader][additional_correspondence][]"  value="2" id="TraderOnSaturday" <?php if(in_array('2',$additional_correspondence)) echo 'checked' ?>/>
                    土曜日対応 </div>
                  <div class="col col-md-2 form-control-static" for="TraderOnSunday">
                    ...
                    <input type="checkbox" name="data[trader][additional_correspondence][]"  value="3" id="TraderOnSunday" <?php if(in_array('3',$additional_correspondence)) echo 'checked' ?>/>
                    日曜日対応 </div>
                  <div class="col col-md-2 form-control-static" for="TraderOnHoliday">
                    ...
                    <input type="checkbox" name="data[trader][additional_correspondence][]"  value="4" id="TraderOnHoliday" <?php if(in_array('4',$additional_correspondence)) echo 'checked' ?>/>
                    祝日対応 </div>
                  <div class="col col-md-2 form-control-static" for="TraderCollectDocument">
                    ...
                    <input type="checkbox" name="data[trader][additional_correspondence][]"  value="5" id="TraderCollectDocument" <?php if(in_array('5',$additional_correspondence)) echo 'checked' ?>/>
                    書類回収代行 </div>
                </div>
              </div>
            </div>
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                <label class="radio-inline" for="TraderTradeRequestFax1">
                  <input type="radio" name="data[trader][withdraw_method]" id="TraderTradeRequestFax1" value="1" @if($trader['withdraw_method']==1) {{'checked'}} @endif   />
                  FAX送信OK</label>
                <label class="radio-inline" for="TraderTradeRequestFax0">
                  <input type="radio" name="data[trader][withdraw_method]" id="TraderTradeRequestFax0" value="0" @if($trader['withdraw_method']==0) {{'checked'}} @endif  />
                  FAX以外希望</label>
              </div>
            </div>
              <div class="form-group col col-md-12">
            ...
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-2">
                <input name="data[trader][complaint_count]" class="form-control" maxLength="13" type="tel" value="{{$trader['complaint_count']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="" class="col col-md-2 control-label">備考</label>
              <div class="col col-md-5">
                <textarea name="data[trader][remark5]" class="form-control" rows="5" cols="30" id="">{{$trader['remark5']}}</textarea>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="" class="col col-md-2 control-label">業者側クレーム回数</label>
              <div class="col col-md-2">
                <input name="data[trader][claim_number]" class="form-control" maxLength="13" type="tel" value="{{$trader['claim_number']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="" class="col col-md-2 control-label">備考</label>
              <div class="col col-md-5">
                <textarea name="data[trader][remark6]" class="form-control" rows="5" cols="30" id="">{{$trader['remark6']}}</textarea>
              </div>
            </div>
            ...
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                <label class="radio-inline" for="TraderClosingDay1">
                  <input type="radio" name="data[trader][payment_closing_date]" id="TraderClosingDay1" value="1" @if($trader['payment_closing_date']==1) {{'checked'}} @endif />
                  引取5日後 (都度払い)</label>
                <label class="radio-inline" for="TraderClosingDay2">
                  <input type="radio" name="data[trader][payment_closing_date]" id="TraderClosingDay2" value="2" @if($trader['payment_closing_date']==2) {{'checked'}} @endif />
                  半月締</label>
                <label class="radio-inline" for="TraderClosingDay3">
                  <input type="radio" name="data[trader][payment_closing_date]" id="TraderClosingDay3" value="3" @if($trader['payment_closing_date']==3) {{'checked'}} @endif />
                  月末締</label>
                <label class="radio-inline" for="TraderClosingDay4">
                  <input type="radio" name="data[trader][payment_closing_date]" id="TraderClosingDay4" value="4" @if($trader['payment_closing_date']==4) {{'checked'}} @endif />
                  翌月末締</label>
                <label class="radio-inline" for="TraderClosingDay9">
                  <input type="radio" name="data[trader][payment_closing_date]" id="TraderClosingDay9" value="5" @if($trader['payment_closing_date']==5) {{'checked'}} @endif />
                  その他</label>
              </div>
            </div>
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                <label class="radio-inline" for="TraderTotalQuality1">
                  <input type="radio" name="data[trader][customer_degree]" id="TraderTotalQuality1" value="1" @if($trader['customer_degree']==1) {{'checked'}} @endif  />
                  C</label>
                <label class="radio-inline" for="TraderTotalQuality2">
                  <input type="radio" name="data[trader][customer_degree]" id="TraderTotalQuality2" value="2" @if($trader['customer_degree']==2) {{'checked'}} @endif  />
                  B</label>
                <label class="radio-inline" for="TraderTotalQuality3">
                  <input type="radio" name="data[trader][customer_degree]" id="TraderTotalQuality3" value="3" @if($trader['customer_degree']==3) {{'checked'}} @endif  />
                  A</label>
                <label class="radio-inline" for="TraderTotalQuality4">
                  <input type="radio" name="data[trader][customer_degree]" id="TraderTotalQuality4" value="4" @if($trader['customer_degree']==4) {{'checked'}} @endif  />
                  S</label>
              </div>
            </div>
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                <label class="radio-inline" for="TraderSendType1">
                  <input type="radio" name="data[trader][method_statement]" id="TraderSendType1" value="1" @if($trader['method_statement']==1) {{'checked'}} @endif   />
                  メール</label>
                <label class="radio-inline" for="TraderSendType2">
                  <input type="radio" name="data[trader][method_statement]" id="TraderSendType2" value="2" @if($trader['method_statement']==2) {{'checked'}} @endif  />
                  FAX</label>
              </div>
            </div>
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                <textarea name="data[trader][remark7]" class="form-control" rows="5" cols="30" id="TraderRemark">{{$trader['remark7']}}</textarea>
              </div>
            </div>
            ...
            <div class="form-group col col-md-4">
              ...
              <div class="col col-md-4 form-control-static text-right" id="balance_credit">{{number_format($trader['credit']-$trader['deposite'])}} 円</div>
            </div>
            <!--id39：与信額編集機能-->
            <div class="form-group col col-md-12">
              <label for="TraderDeficiencyAccount" class="col col-md-2 control-label">過不足金</label>
              <div class="col col-md-2" style="width: 188px;">
                <input name="data[trader][excess_deficit_money]" class="form-control" maxLength="10" type="number" value="{{$trader['excess_deficit money']}}"/>
              </div>
              <div class="col col-md-1 form-control-static"> 円</div>
            </div>
            <div class="form-group col col-md-4">
              ...
              <div class="col col-md-6" style="padding-left: 25px;">
                <input name="data[trader][bank_name]" class="form-control" maxLength="30" type="text" value="{{$trader['bank_name']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-8">
              <label for="TraderBankCode" class="col col-md-2 control-label">金融機関コード</label>
              <div class="col col-md-2">
                <input name="data[trader][bank_code]" class="form-control" maxLength="4" type="tel" value="{{$trader['bank_code']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-4">
              <label for="TraderBranchName" class="col col-md-6 control-label" style="padding-right: 5px;">支店名</label>
              <div class="col col-md-6" style="padding-left: 25px;">
                <input name="data[trader][branch_name]" class="form-control" maxLength="30" type="text" value="{{$trader['branch_name']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-8">
              <label for="TraderBranchNumber" class="col col-md-2 control-label">支店番号</label>
              <div class="col col-md-2">
                <input name="data[trader][branch_code]" class="form-control" maxLength="3" type="tel" value="{{$trader['branch_code']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-5">
                ...
                <label class="radio-inline" for="TraderAccountClassification1">
                  <input type="radio" name="data[trader][account_type]" id="TraderAccountClassification1" value="1"  @if($trader['method_statement']==1) {{'checked'}} @endif />
                  普通 </label>
                <label class="radio-inline" for="TraderAccountClassification2">
                  <input type="radio" name="data[trader][account_type]" id="TraderAccountClassification2" value="2" @if($trader['method_statement']==2) {{'checked'}} @endif />
                  当座 </label>
                <label class="radio-inline" for="TraderAccountClassification4">
                  <input type="radio" name="data[trader][account_type]" id="TraderAccountClassification4" value="3" @if($trader['method_statement']==3) {{'checked'}} @endif />
                  貯蓄 </label>
                <label class="radio-inline" for="TraderAccountClassification9">
                  <input type="radio" name="data[trader][account_type]" id="TraderAccountClassification9" value="4" @if($trader['method_statement']==4) {{'checked'}} @endif />
                  その他 </label>
              </div>
            </div>
            <div class="form-group col col-md-12">
              ...
              <div class="col col-md-2">
                <input name="data[trader][account_number]" class="form-control" maxLength="7" type="tel" value="{{$trader['account_number']}}"/>
              </div>
            </div>
            <div class="form-group col col-md-12">
              <label for="TraderNomineeName" class="col col-md-2 control-label">口座名義人 (カタカナ)</label>
              <div class="col col-md-5">
                <input name="data[trader][account_holder]" class="form-control katakana" maxLength="100" type="text" value="{{$trader['account_holder']}}"/>
              </div>
            </div>
  ...
  <script>
      $(function() {
          $(".popup").click(function(e)
          {
              ...
              var corresponding_erea = $("#Trader_erea").val();
              if(first_name == '')
              {
                  e.preventDefault();
              }
              else
              {
                  ...
                  $.ajax({
                      ...
                      data: {first_name: first_name,corresponding_erea:corresponding_erea, fuel_csrf_token: current_token},
                      success: function( data, textStatus, jQxhr ){
                          $('#erea_status').val('1');
                          window.open('/trader/area', '_blank');
                      },
